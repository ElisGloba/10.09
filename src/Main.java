...
//        Main person = new Main("Александр Смирнов", 35, "Мужчина");
//        person.displayInfo();
//
//        System.out.println("\nУвеличиваем возраст...");
//        person.increaseAge();
...
//
//        System.out.println("\nМеняем имя...);
//        person.changeName("Анна Смирнова");
//        person.displayInfo();
//    }
//}
...
class Manager extends Worker {
    ...
    @Override
    public String toString() {
        return super.toString() + ", Количество подчиненных:: " + subordinates.size();
    }
}
public class Main {
    private String name;
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Введите возраст менеджера: ");
        int age = scanner.nextInt();
        System.out.print("Введите зарплату менеджера: ");
        double salary = scanner.nextDouble();
        Manager manager = new Manager(name, age, salary);
        System.out.print("Введите количество подчиненных: ");
...
class Car extends Transport {
    @Override
    public void move() {
        System.out.println("Автомобиль движется на 4 колесам..");
    }
}
class Bike extends Transport {
    @Override
    public void move() {
        System.out.println("Велосипед движется на 2 колесам.");
    }
}
public class main {
    public static void main(String[] args) {
...
public class main {
    public static void main(String[] args) {
        ...
        library.addBook(new Book("Мир вокруг нас", "Елена Иванова", 2000));
        library.addBook(new Book("Приключения в лесу", "Дмитрий Петров", 2010));
                System.out.println("Все книги: ");
        library.displayBooks();
        System.out.println("\nBooks by Елена Иванова:");
